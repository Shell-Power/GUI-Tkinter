...
def hello():
    ...
    #======================details ==========================================================
            detailsframe= Frame(self.root, bg="purple",bd=20, relief=RIDGE)
    ...
    #==================================right==============================================
            ...
            labeldob = Entry(dataframeleft, font=("consolas",13, "bold"),textvariable=self.labeljoindate, width=32, bd=2)
    ...
    #===============================================BUTTONS====================================================================
            ...
            button1= Button(buttonframe, text="Exit", font=("consolas",13,"bold"),command=exxit,bg="lime", width=23, height=1, padx=2, pady=6)
